...
const About = () => {
  return (
    <div className="flex  flex-col gap-5 sm:items-start justify-center md:px-10">
      {/* <div className="hidden md:block absolute w-[50%] bottom-0 gradient-04" /> */}

      <h2 className="text-black text-[1.4rem] md:text-3xl font-medium underline">
        About RMS Lab
      </h2>
      <p className="text-[1rem]  md:text-[1rem] leading-relaxed text-left md:text-xl text-black tracking-wide">
