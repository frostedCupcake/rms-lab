    ...
    return (
        <div>
            ...
            <div className="p-4 mt-[8rem] px-[8rem]">
                ...
                <p className="italic">To meet personally, please make an email appointment: <a href="mailto:subharath@bme.iith.ac.in" className="text-blue-600">
                    subharath@bme.iith.ac.in
                </a></p>
                <h2 className="text-xl font-bold mt-4 capitalize">FOR FUTURE STUDENTS</h2>
                <p>
                    We seek highly enthusiastic and motivated students to work in this
                    lab. The students should have one of the following speciality degrees:
                    Biotechnology, Material Science, Chemical engineering, Mechanical
                    engineering, Life Sciences, and not in that order. Find my google
                    scholar citation works{" "}
                    ...
                    <a href="https://www.iith.ac.in/phdadmissions/" className="text-blue-600">
                        link
                    </a>
                    .
                </p>
